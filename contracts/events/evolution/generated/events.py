...
SCHEMA_REGISTRY = frozenset((('control_device.invalidated', '1.1'), ('inspection.result', '1.1'), ('item.registered', '1.1'), ('machine.state', '1.1'), ('operation.finished', '1.1'), ('operation.started', '1.1'), ('operator.action', '1.1')))
PAYLOAD_MODELS = {
