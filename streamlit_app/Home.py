...
if permissions.intersection({"RUN_BLAST_RADIUS", "APPROVE_CONTAINMENT", "INVALIDATE_CONTROL_DEVICE"}):
    pages.append(st.Page(views.guarded(views.blast_radius), title="Risk / Blast Radius", icon="🎯"))
